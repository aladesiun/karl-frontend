                ...
                <div class="row">
                    <div class="col-12">
                        <ol class="breadcrumb d-flex align-items-center">
                            ...
                            <li class="breadcrumb-item"><router-link to="#">Dresses</router-link></li>
                            <li class="breadcrumb-item active">Long Dress</li>
                        </ol>
                        <!-- btn -->
                        <router-link to="#" class="backToHome d-block"><i class="fa fa-angle-double-left"></i> Back to Category</router-link>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <router-link class="gallery_img" to="img/product-img/product-9.jpg">
                                        <img class="d-block w-100" src="img/product-img/product-9.jpg" alt="First slide">
                                    </router-link>
                                    </div>
                                    <div class="carousel-item">
                                        <router-link class="gallery_img" to="img/product-img/product-2.jpg">
                                        <img class="d-block w-100" src="img/product-img/product-2.jpg" alt="Second slide">
                                    </router-link>
                                    </div>
                                    <div class="carousel-item">
                                        <router-link class="gallery_img" to="img/product-img/product-3.jpg">
                                        <img class="d-block w-100" src="img/product-img/product-3.jpg" alt="Third slide">
                                    </router-link>
                                    </div>
                                    <div class="carousel-item">
                                        <router-link class="gallery_img" to="img/product-img/product-4.jpg">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <h4 class="title"><router-link to="#">Long Yellow Dress</router-link></h4>
                            ...
                            <div class="widget size mb-50">
                                ...
                                <div class="widget-desc">
                                    <ul>
                                        ...
                                        <li><router-link to="#">34</router-link></li>
                                        <li><router-link to="#">36</router-link></li>
                                        <li><router-link to="#">38</router-link></li>
                                        <li><router-link to="#">40</router-link></li>
                                        <li><router-link to="#">42</router-link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="accordion" role="tablist">
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingOne">
                                        <h6 class="mb-0">
                                            <router-link data-toggle="collapse" to="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Information</router-link>
                                        </h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingTwo">
                                        <h6 class="mb-0">
                                            <router-link class="collapsed" data-toggle="collapse" to="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Cart Details</router-link>
                                        </h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingThree">
                                        <h6 class="mb-0">
                                            <router-link class="collapsed" data-toggle="collapse" to="#collapseThree" aria-expanded="false" aria-controls="collapseThree">shipping &amp; Returns</router-link>
                                        </h6>
                                    </div>
